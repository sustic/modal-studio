    ...
    <div className="flex min-h-screen flex-col bg-[#0a0a0a]">
      ...
      <div className="flex flex-1">
        ...
        <aside className="hidden w-52 shrink-0 flex-col gap-0.5 border-r border-white/[0.06] px-3 py-4 md:flex">
          <p className="mb-1 px-2 text-[11px] font-medium uppercase tracking-widest text-white/25">
            Workspace
          </p>
        ...
        <main className="flex flex-1 flex-col px-8 py-8">
          ...
          <div className="mb-3 flex items-center justify-between">
            ...
            <button
              disabled
              className="flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-[12px] font-medium text-white/25 transition-colors hover:bg-white/[0.04] hover:text-white/50 disabled:cursor-not-allowed"
            >
          ...
          <div className="flex flex-1 flex-col items-center justify-center rounded-lg border border-dashed border-white/[0.08] py-24">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/[0.04]">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden>
                <rect x="2.5" y="4.5" width="13" height="9" rx="1.5" stroke="white" strokeOpacity="0.2" strokeWidth="1.2" />
                <path d="M5.5 8h7M5.5 10.5h4" stroke="white" strokeOpacity="0.2" strokeWidth="1.2" strokeLinecap="round" />
              </svg>
            </div>
            <p className="mt-3 text-[13px] font-medium text-white/30">
              Your projects will appear here
            </p>
            <p className="mt-1 max-w-xs text-center text-[12px] text-white/20">
